...
@interface TSGRExtensionViewController () {
    UILabel *redLabel;
    UILabel *blueLabel;
    UILabel *greenLabel;
}
...
@implementation TSGRExtensionViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = NSLocalizedString(@"UIView+CJGR 手势验证", nil);
